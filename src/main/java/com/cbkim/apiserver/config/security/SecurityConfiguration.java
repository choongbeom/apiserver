...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
        ...
        http
            ...
            .and()
                .authorizeRequests()                                                    // 다음 리퀘스트에 대한 사용권한 체크
                    ...
                    .antMatchers(HttpMethod.GET, "/*/email", "/*/email/**").permitAll()   // 조회는 누구나 접근가능
                    .antMatchers(HttpMethod.POST,"/*/email", "/*/email/**").permitAll()   // .hasAnyAuthority("ROLE_ROOT")  // 관리자만 가능
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        allowedOrigins.add("http://localhost:4444");
        allowedOrigins.add("http://127.0.0.1:4444");
        allowedOrigins.add("http://172.16.49.55:4444");
        ...
        allowedOrigins.add("https://petstore.swagger.io");

        // todo list 전부 허용하면 안되는데
        //configuration.setAllowedOrigins(allowedOrigins);
        //configuration.addAllowedOrigin("*");  // CORS 이슈 발생 시 setAllowedOriginPatterns를 사용해야 함.
